import logo from "/public/MTLogo.svg"
  ...
  <div className="px-4">
    <div className="flex justify-between w-full">
        ...
        <div className="hidden md:flex items-center w-fit mr-0">
          ...
          <a href="/Resume.pdf" className="px-3 text-white hover:text-zinc-400">Resume</a>
        </div>
